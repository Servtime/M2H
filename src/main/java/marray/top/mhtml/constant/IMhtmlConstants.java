...
public interface IMhtmlConstants {
     ...
     * PNG的Content-Type正则
     */
    String PNG_REGEX = "\\bContent-Type(\\s)*:(\\s)*image/png\\b";
    /**
     * jpeg的Content-Type正则
     */
    String JPEG_REGEX = "\\bContent-Type(\\s)*:(\\s)*image/jpeg\\b";
    /**
     * gif的Content-Type正则
     */
    String GIF_REGEX = "\\bContent-Type(\\s)*:(\\s)*image/gif\\b";
    /**
     * 编码转换格式
     */
